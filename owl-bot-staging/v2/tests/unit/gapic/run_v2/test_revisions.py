...
def test_revisions_client_from_service_account_info(client_class):
...
def test_revisions_client_from_service_account_file(client_class):
    creds = ga_credentials.AnonymousCredentials()
...
def test_get_revision(request_type, transport: str = 'grpc'):
    ...
    assert response.execution_environment == vendor_settings.ExecutionEnvironment.EXECUTION_ENVIRONMENT_DEFAULT
...
def test_revisions_host_no_port():
    client = RevisionsClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
def test_revisions_host_with_port():
    client = RevisionsClient(
        credentials=ga_credentials.AnonymousCredentials(),
