...
class TasksRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    def post_list_operations(self, response: operations_pb2.ListOperationsRequest) -> operations_pb2.ListOperationsResponse:
        ...
        """
        return response
    def pre_wait_operation(self, request: operations_pb2.WaitOperationRequest, metadata: Sequence[Tuple[str, str]]) -> operations_pb2.Operation:
    ...
    def post_wait_operation(self, response: operations_pb2.WaitOperationRequest) -> operations_pb2.Operation:
